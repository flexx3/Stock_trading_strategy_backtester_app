...
class EmaStrategy(bt.Strategy):
    params = dict(shorter_ema_period= 10, longer_ema_period= 20)
    ...
    def __init__(self):
        ...
        #setup ema indicator
        self.shorter_ema = bt.indicators.EMA(self.datas[0], period= self.p.shorter_ema_period)
        self.longer_ema = bt.indicators.EMA(self.datas[0], period= self.p.longer_ema_period)
    ...
    def next(self):
        ...
        if not self.position:
            if (self.shorter_ema[0] > self.longer_ema[0]):
